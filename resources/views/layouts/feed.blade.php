...
change        class="relative mx-auto h-full max-w-7xl"
    >
        <x-sidebar
            ...
            x-ref="sidebar"
            class="top-16 hidden bg-slate-900 xl:fixed"
        />
        ...
        <div class="xl:pl-72">
            ...
            <div class="h-full xl:grid xl:grid-cols-3">
                <main class="col-span-2 w-full xl:max-w-2xl">
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <div class="flex flex-1 flex-col">
                                        <textarea rows="3" name="post" id="post"
                                                  class="block w-full rounded-lg border border-white/10 bg-white/5 text-white shadow-sm transition py-1.5 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/20 xl:text-sm"
                                        ...
                                        <div class="mt-4 flex justify-between">
                                            ...
                                            <div class="text-right text-xs text-gray-400">0 / 1000</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul role="list" class="border-t border-white/5 divide-y divide-white/5">
                        <li class="cursor-pointer p-6 hover:bg-gray-800/20 xl:p-8">
                            <div class="flex justify-between">
                                <a href="https://pinkary.com/@developermithu"
                                   class="flex items-center gap-3 group/profile">
                                    <figure
                                        class="flex-shrink-0 rounded-full bg-gray-800 group-hover/profile:opacity-90 transition-opacity size-10">
                                        <img
                                            src="https://pinkary.com/storage/avatars/3d344ad52744ea44975f46f815a6299c7fc2c3e007831d4a5217069b8f04f13a.png"
                                            alt="developermithu" class="rounded-full size-10">
                                    </figure>
                                    <div class="overflow-hidden text-sm">
                                        ...
                                        <p class="truncate group-hover/profile:text-gray-400 text-gray-500 transition-colors">
                                            @developermithu</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="mt-3 overflow-hidden break-words text-sm text-gray-200">
                                <p>How do you deploy <a class="cursor-pointer text-pink-500 hover:underline"
                                                        href="/hashtag/Laravel">#Laravel</a> applications?<br><br>A)
                                    Laravel Forge<br>B) Self-hosted solutions</p>
                            </div>

                            <div class="mt-3 flex items-center justify-between text-sm text-gray-500">
                                <div class="flex items-center gap-2">
                                    <a href="https://pinkary.com/@developermithu/questions/9d6ceade-3e53-4211-8063-a923d1bae5c1"
                                       class="flex cursor-pointer items-center transition-colors group-hover:text-pink-500 hover:text-gray-400 focus:outline-none">
                                    ...
                                    <button
                                        class="flex items-center transition-colors hover:text-gray-400 focus:outline-none">
                                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                             fill="none">
                                            <path
                                ...
                                <div class="flex items-center text-gray-500">
                                    <time class="cursor-help text-xs" title="Wed, 6 November 2024 16:41"
                                          datetime="2024-11-06T16:41:19+00:00">50m ago
                                    </time>
                                </div>
                            </div>
                        </li>
                        <li class="cursor-pointer p-6 hover:bg-gray-800/20 xl:p-8">
                            ...
                            <div class="mt-3 overflow-hidden break-words text-sm text-gray-200">
                                <p>⚡ Boost Filament table performance! Load large datasets asynchronously with
                                    deferLoading() to keep things fast and smooth. 🌐✨<br><br>
                                    <a class="mr-1 cursor-pointer text-pink-500 hover:underline"
                                       href="/hashtag/Laravel">#Laravel</a>
                                    <a class="mr-1 cursor-pointer text-pink-500 hover:underline"
                                       href="/hashtag/Laravel">#Filament</a>
                                    <a class="mr-1 cursor-pointer text-pink-500 hover:underline"
                                       href="/hashtag/Laravel">#PHP</a>
                                </p>

                                <br>

                                <img class="mx-auto cursor-pointer rounded-lg object-contain"
                                     src="https://pinkary.com/storage/images/2024-11-06/xOYu0HM9By1bPbUSYq2WpwlqCckDzR0iRoyKW9Hi.png"
                                     alt="image" data-navigate-ignore="true">
                            </div>
