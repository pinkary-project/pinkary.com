        ...
        <div class="flex h-16 justify-between">
            ...
            <div class="flex items-center" x-data>
                ...
                @auth
                    ...
                    <a href="{{ route('updates.create') }}" class="mr-2" wire:navigate>
                        <button
                            type="button"
                            class="{{ request()->routeIs('updates.create') ? 'bg-gray-800 text-gray-50' : 'bg-gray-800 text-gray-400 hover:text-gray-50' }} inline-flex items-center rounded-md border border-transparent bg-gray-800 px-3 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out hover:text-gray-50 focus:outline-none"
                        >
