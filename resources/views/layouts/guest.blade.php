    ...
    <div class="flex min-h-screen flex-col">
        <main class="grow">
            <div class="mx-auto grid min-h-[calc(100vh-9rem)] w-full max-w-7xl xl:grid-cols-[18rem_minmax(0,1fr)_18rem]">
                <aside class="hidden border-x border-slate-200/70 bg-white/85 px-6 xl:flex xl:flex-col dark:border-slate-800/30 dark:bg-[#07101f]/80">
                    <a
                ...
                <div class="flex min-h-full flex-col justify-center border-slate-200/70 px-4 py-10 sm:px-6 xl:border-r xl:px-8 dark:border-slate-800/30">
                    <a
                        href="{{ route('home.feed') }}"
                        wire:navigate
                    ...
                    <div class="mx-auto w-full max-w-md rounded-md border border-slate-200/70 bg-white/95 p-6 shadow-xl shadow-slate-900/5 sm:p-8 dark:border-slate-800/30 dark:bg-[#07101f]/95 dark:shadow-black/20">
                        {{ $slot }}
                    </div>
                </div>

                <aside class="hidden bg-white/85 xl:flex xl:flex-col xl:border-r xl:border-slate-200/70 dark:bg-[#07101f]/80 dark:xl:border-slate-800/30">
                    <div class="border-b border-slate-200/70 p-8 dark:border-slate-800/30">
                        ...
                        <p class="mt-1 text-xs/6 text-slate-500 dark:text-slate-500">
                            Sign in and keep your Pinkary profile moving.
                        </p>
                    </div>
