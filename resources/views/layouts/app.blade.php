...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        class="bg-slate-100 bg-center bg-repeat font-sans text-slate-950 antialiased dark:bg-slate-950 dark:text-slate-50"
                ...
                @if (isset($title))
                    <div class="mb-6 mt-20 flex flex-col items-center sm:mb-12">
                        <div class="w-full max-w-md px-2 sm:px-0">
                            <h1 class="font-mona text-2xl font-medium text-slate-900 dark:text-slate-200">
                                {{ $title }}
                            </h1>
                        </div>
                    </div>
