        ...
        <div class="space-y-0">
            ...
            @else
                <div class="m-6 border border-dashed border-slate-300/80 bg-slate-50/70 p-6 text-center dark:border-slate-800/50 dark:bg-[#0b1324]">
                    <h3 class="font-mona text-xl font-semibold text-slate-950 dark:text-white">
                        Sign in for a personalized feed
                    </h3>
                    <p class="mt-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Log in or sign up to access personalized content. Following is already supported. You just need
                        an account to see posts from the people you follow.
                    </p>
