                ...
                <div class="p-6 sm:px-20">
                    ...
                    <div class="mt-6 text-gray-500">
                        <div class="mx-auto max-w-4xl text-sm text-gray-500">
                            ...
                            <p>Welcome to Pinkary ("we," "us," "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at team @pinkary.com.</p>

                            <h2 class="mb-2 mt-6 text-2xl font-semibold">1. Information We Collect</h2>
                            <p>We may collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and services, participate in activities on the Services, or otherwise when you contact us.</p>
                            ...
                            <p>However, we may also collect additional information when delivering our Services to you to ensure necessary and optimal performance. These methods of collection may not be as obvious to you, so we wanted to highlight and explain them below:</p>
                            <ul class="ml-8 list-disc">
                            ...
                            <ul class="ml-8 list-disc">
                                ...
                                <li>
                                    For business transfers: We may share or transfer your information in connection
                            ...
                            <p>Under the General Data Protection Regulation (GDPR), you have certain rights regarding your personal information. These include the right to request access, correction, deletion, or restriction of your personal information, and the right to data portability. If you wish to exercise any of these rights, please contact us.</p>
                            ...
                            <p>If you have questions or comments about this policy, you may email us at <a href="mailto:team@pinkary.com">team@pinkary.com</a> .</p>
                        </div>
                    </div>
                </div>
            </div>
