    ...
    <div x-data="{ recovery: false }">
        ...
        @if ($errors->any())
            <div class="mb-5 rounded-[1.25rem] border border-red-500/20 bg-red-500/10 px-4 py-3">
                ...
                <ul class="mt-3 list-inside list-disc text-sm text-red-700 dark:text-red-300">
        ...
        >
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <button
                    type="button"
                    class="text-left text-sm font-medium text-pink-500 transition hover:text-pink-400 sm:text-center"
                    x-show="! recovery"
                    x-on:click="
                        recovery = true;
                        $nextTick(() => {
