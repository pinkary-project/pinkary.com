    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <div class="flex items-center">
                ...
                <x-input-label for="terms">
                    ...
                    <a target="_blank" href="{{ route('terms') }}" class="text-pink-500 underline hover:no-underline">
                        Terms of Service
                    </a>
                    and
                    <a
        ...
        <div class="mt-4 flex items-center justify-end space-x-3.5 text-sm">
            <div>
                ...
                <a
                    class="rounded-md text-sm text-slate-800 underline hover:no-underline focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 dark:text-slate-200"
                    href="{{ route('login') }}"
                    wire:navigate
                >
                    {{ __(' Sign in here') }}
