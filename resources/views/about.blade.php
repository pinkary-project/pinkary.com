<x-about-layout>
    ...
    <main class="my-8 flex w-full flex-1 flex-col items-center justify-center gap-8 overflow-x-hidden p-4 pb-12">
        ...
        <h2 class="font-mona mt-12 max-w-4xl text-center text-3xl font-light md:text-4xl" style="font-stretch: 120%">
        ...
        <section class="relative mt-20 grid w-full max-w-2xl grid-cols-1 place-items-center gap-2 md:grid-cols-2">
            <div class="absolute top-0 -left-20 h-56 w-56 rounded-full bg-linear-to-r from-teal-500 via-transparent to-emerald-300 blur-3xl"></div>

            <div class="z-10 order-2 mt-10 w-full max-w-sm md:order-1 md:mt-0">
                <livewire:home.users />
            </div>

            <div class="order-1 flex cursor-pointer flex-col items-center justify-center transition-transform duration-700 sm:max-w-md md:order-2 md:translate-x-10 md:-translate-y-10 md:items-start md:hover:translate-x-5 md:hover:-translate-y-5">
        ...
        <section class="relative mt-20 flex w-full max-w-3xl flex-col place-items-center gap-2 md:flex-row">
            <div class="absolute top-0 -right-20 -z-10 h-56 w-56 rotate-180 rounded-full bg-linear-to-r from-teal-500 via-transparent to-emerald-300 blur-3xl"></div>
            ...
            <div class="flex cursor-pointer flex-col items-center justify-center text-left transition-transform duration-700 sm:max-w-md md:-translate-x-10 md:-translate-y-10 md:items-end md:text-right md:hover:-translate-x-5 md:hover:-translate-y-5">
                ...
                <svg
                    class="mt-12 mr-16 hidden h-auto w-20 rotate-45 md:block"
                    viewBox="0 0 220 87"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >
        ...
        <section class="mt-40 mb-16 flex flex-col items-center gap-8">
            @auth
                <h3
                    class="font-mona mb-4 w-full max-w-2xl text-center text-3xl font-light md:text-4xl"
                    style="font-stretch: 120%"
                >
