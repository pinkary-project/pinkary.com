<x-about-layout>
    ...
    <nav
        class="fixed top-0 z-20 flex w-full justify-end gap-2 border-b border-slate-900/10 bg-slate-100/20 p-4 shadow-2xl backdrop-blur-md dark:border-slate-200/10 dark:bg-slate-950/20"
    >
        <a href="{{ route('home.feed') }}" wire:navigate>
            <x-primary-colorless-button
                class="flex items-center justify-center gap-2 border-slate-900 dark:border-white"
            >
    ...
    <main class="my-8 flex w-full flex-1 flex-col items-center justify-center gap-8 overflow-x-hidden p-4 pb-12">
        ...
        <section class="mt-28 w-full max-w-2xl">
            <div class="grid w-full gap-4 md:grid-cols-2">
                <div
                    class="rounded-2xl border-none bg-slate-50 p-4 shadow-sm transition-colors md:aspect-video dark:border-t dark:border-slate-800 dark:bg-slate-900 dark:shadow-none"
                >
                    <div
                        class="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-slate-200 dark:bg-slate-950"
                    >
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Choose a username, add a bio, and you're good to go.
                    </p>
                </div>

                <div
                    class="rounded-2xl border-none bg-slate-50 p-4 shadow-sm md:aspect-video dark:border-t dark:border-slate-800 dark:bg-slate-900 dark:shadow-none"
                >
                    <div
                        class="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-slate-200 dark:bg-slate-950"
                    >
                ...
                >
                    ...
                    <h3>Discover</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Keep an eye on the people you admire, and expand your circle.
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="mt-28 flex max-w-2xl flex-col items-center gap-4 py-4 text-2xl font-light">
            ...
            <h2 class="text-center">
                ...
                ! You can help us by contributing or
