    ...
    <main class="my-8 flex w-full flex-1 flex-col items-center justify-center gap-8 overflow-x-hidden p-4 pb-12">
        <section class="mt-24 flex flex-col items-center">
            <a href="{{ route('about') }}" wire:navigate>
                <h2 class="text-5xl font-['poppins'] font-bold">batuly</h2>
            </a>

            <div class="mt-5 rounded-full bg-pink-500 bg-opacity-90 px-3 py-1.5 font-mona text-sm font-medium uppercase text-slate-900"
        ...
        <section class="mt-28 w-full max-w-2xl">
            <div class="grid w-full gap-4 md:grid-cols-2">
                <div
                    ...
                    <p class="dark:text-slate-400 text-slate-500 text-sm">Choose a username, add a bio, and you're good
                        to go.</p>
                </div>
                ...
                <div
                    ...
                    <p class="dark:text-slate-400 text-slate-500 text-sm">Collect links of your social profiles, your
                        work, and what matters to you.</p>
                </div>
                ...
                <div
                    ...
                    <p class="dark:text-slate-400 text-slate-500 text-sm">Engage with the community in an open and
                        friendly way.</p>
                </div>
                ...
                <div
                    ...
                    <h3>Discover</h3>
                    <p class="dark:text-slate-400 text-slate-500 text-sm">Keep an eye on the people you admire, and
        ...
        <section class="relative mt-20 grid w-full max-w-2xl grid-cols-1 place-items-center gap-2 md:grid-cols-2">
            <div
                class="absolute -left-20 top-0 h-56 w-56 rounded-full bg-gradient-to-r from-teal-500 via-transparent to-emerald-300 blur-3xl">
            </div>
            ...
            <div
                class="order-1 flex cursor-pointer flex-col items-center justify-center transition-transform duration-700 sm:max-w-md md:order-2 md:-translate-y-10 md:translate-x-10 md:items-start md:hover:-translate-y-5 md:hover:translate-x-5">
                ...
                <svg class="ml-16 mt-10 hidden h-auto w-24 -rotate-45 md:block" viewBox="0 0 251 81" fill="none"
        ...
        <section class="relative mt-20 flex w-full max-w-3xl flex-col place-items-center gap-2 md:flex-row">
            ...
            <div
                ...
                <p class="w-full text-slate-400">Pinkary has a simple and direct way to communicate, even anonymously.
                </p>
        ...
        <div class="mt-28 flex max-w-2xl flex-col items-center gap-4 py-4 text-2xl font-light">
            ...
            <h2 class="text-center">
                Pinkary is now <a href="https://github.com/pinkary-project/pinkary.com" target="_blank"
                    class="underline hover:no-underline">open-source</a>! You can help us by contributing or
                <a href="https://github.com/sponsors/nunomaduro" target="_blank"
                    class="underline hover:no-underline">sponsoring the project on GitHub
                </a>
                .
            </h2>
        </div>
        ...
        <section class="mb-16 mt-40 flex flex-col items-center gap-8">
            @auth
                <h3 class="mb-4 w-full max-w-2xl text-center font-mona text-3xl font-light md:text-4xl"
                    style="font-stretch: 120%">
