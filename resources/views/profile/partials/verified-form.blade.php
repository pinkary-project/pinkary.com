    ...
    <header>
        <h2 class="text-lg font-medium text-gray-400">
            <div class="items flex">
                <h2 class="text-lg font-medium text-gray-400">{{  $user->is_verified ? __('Manage Verified Badge') : __('Get Verified') }}</h2>
                ...
                @else
                    <div class="flex items-center gap-4">
                        ...
                        <form method="post" action="{{ route('profile.verified.update') }}">
                            ...
                            <x-secondary-button type="submit">{{ __('Refresh Verified Eligibility') }}</x-secondary-button>
                        </form>
