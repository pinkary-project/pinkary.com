...
>
    ...
    <div
        x-show="show"
        class="{{ $maxWidth }} {{$contentOverflowStyle}} transform rounded-lg border border-slate-800/80 bg-[#050d1b] shadow-xl shadow-black/40 transition-all sm:mx-auto sm:w-auto"
        x-transition:enter="duration-300 ease-out"
