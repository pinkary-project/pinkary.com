<div class="mb-8 flex justify-between space-x-4">
    <a href="{{ route('explore.users') }}" class="{{ request()->routeIs('explore.users') ? 'text-slate-100 bg-pink-600' : 'text-slate-500 hover:text-slate-100 bg-slate-900 ' }} inline-flex flex-1 items-center justify-center rounded-md border border-transparent px-3 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out focus:outline-none" wire:navigate>
