    ...
    <div class="mb-8 w-full max-w-md">
        <div class="relative flex items-center py-1">
            ...
            <x-text-input
                ...
                class="mx-1 w-full !rounded-2xl !bg-slate-50 !bg-opacity-80 py-3 pl-14 dark:!bg-slate-950"
            />
        </div>
    </div>
        ...
        <section class="max-w-2xl">
            <ul class="flex flex-col gap-2">
                @foreach ($users as $user)
                    ...
                    >
                        <div
                            class="group flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:bg-slate-100 dark:border-slate-900 dark:bg-slate-950 dark:bg-opacity-80 dark:hover:bg-slate-900"
                        >
                            <figure
                            ...
                            <div class="flex flex-col overflow-hidden text-left text-sm">
                                <a
                                    ...
                                    x-ref="parentLink"
                                >
                                    <p class="truncate text-wrap font-medium text-black dark:text-white">
                                        {{ $user->name }}
                                    </p>
