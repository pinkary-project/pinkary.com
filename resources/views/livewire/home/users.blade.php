<div class="mb-10 w-full text-slate-200">
    <div class="mb-6 border border-slate-800 bg-[#071121]/95 p-4 sm:p-5">
        ...
        <div class="relative mt-4 flex items-center">
            ...
            <x-text-input
                ...
                class="w-full !rounded-none !border-slate-800 !bg-[#050d1b] !py-3 !pl-12 !text-white shadow-none placeholder:!text-slate-500 dark:!border-slate-800 dark:!bg-[#050d1b] dark:placeholder:!text-slate-500"
            />
        </div>
    </div>

    @if ($users->isEmpty())
        <section class="border border-dashed border-slate-800 bg-[#071121]/95 p-6 text-center">
    ...
    @else
        <section>
            <ul class="divide-y divide-slate-800 border border-slate-800 bg-[#071121]/60">
                @foreach ($users as $user)
                    ...
                    >
                        <div class="group flex items-center gap-3 px-4 py-4 transition-colors hover:bg-[#0a1325] sm:px-5">
