<div class="mb-20 flex flex-col gap-2">
    @foreach ($notifications as $notification)
        ...
        <div class="relative group overflow-hidden rounded-2xl border border-slate-900 bg-slate-950 bg-opacity-80 p-4 transition-colors hover:bg-slate-900">
            ...
            <a href="{{ route('notifications.show', ['notification' => $notification->id]) }}" wire:navigate class="absolute inset-0"></a>
        </div>
    @endforeach
