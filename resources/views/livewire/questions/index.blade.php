<section class="mb-12">
    @if ($pinnedQuestion)
        <div data-question-item class="border-b border-slate-200 px-2 py-2 dark:border-slate-700/50">
    ...
    @foreach ($questions as $question)
        <div data-question-item class="border-b border-slate-200 px-2 py-2 last:border-b-0 dark:border-slate-700/50">
            <x-thread
