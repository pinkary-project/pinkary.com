<article class="block" id="q-{{ $questionId }}" x-data="copyCode">
    ...
    @if ($question->answer)
        <div data-parent=true x-data="clickHandler" x-on:click="handleNavigation($event)"
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if (!$question->is_ignored && auth()->user()->can('ignore', $question))
                                <x-dropdown-button data-navigate-ignore="true" wire:click="ignore"
            ...
            <div x-data="showMore">
                <div class="mt-3 break-words text-slate-200 overflow-hidden answer" wire:ignore.self x-ref="parentDiv">
                    <p>
                        {!! $question->answer !!}
                    </p>
                </div>
            ...
            <div class="mt-3 flex items-center justify-between text-sm text-slate-500">
                <div class="flex items-center gap-1">
                    ...
                    <button data-navigate-ignore="true"
                        @if ($likeExists) wire:click="unlike"
                        @else
                            wire:click="like" @endif
                        x-data="particlesEffect" x-on:click="executeParticlesEffect($event)"
                ...
                <div class="flex items-center text-slate-500 ">
                    ...
                    <x-dropdown align="left" width="48" dropdown-classes="top-[-3.4rem] shadow-none"
