...
>
    <form
        ...
        class="border-b border-slate-800/30 pb-3"
    >
        <div class="flex items-start gap-2.5">
            <figure class="{{ $user->is_company_verified ? 'rounded-2xl' : 'rounded-full' }} hidden h-12 w-12 flex-shrink-0 overflow-hidden border border-slate-800/30 bg-[#10182b] sm:block">
                <img
                    src="{{ $user->avatar_url }}"
                    alt="{{ $user->username }}"
            ...
            <div class="min-w-0 flex-1">
                <div class="relative group/menu">
                        <div x-data="{ content: $persist($wire.entangle('content')).as('{{ $this->draftKey }}') }" class="p-0">
                            <x-textarea
                                ...
                                x-ref="content"
                                autocomplete
                                class="!min-h-[4.25rem] !rounded-none !border-slate-800/30 !bg-[#10182b] !px-3.5 !py-2.5 !text-[0.95rem] !leading-7 !text-white shadow-none placeholder:!text-slate-500 dark:!border-slate-800/30 dark:!bg-[#10182b] dark:placeholder:!text-slate-500"
                            />
                ...
                <button
                    ...
                    class="flex size-10 items-center justify-center border border-slate-800/30 bg-[#10182b] text-sm text-slate-400 hover:bg-[#162038] hover:text-white"
