<x-modal name="followers" maxWidth="2xl">
    <div
        class="p-4 md:p-10"
        x-on:open-modal.window="$event.detail == 'followers' ? $wire.set('isOpened', true) : null"
    >
        <div>
                ...
                <ul class="flex flex-col gap-2">
                    @foreach ($followers as $follower)
                        ...
                        >
                            ...
                            >
                                <figure
                                    class="{{ $follower->is_company_verified ? 'rounded-md' : 'rounded-full' }} h-12 w-12 flex-shrink-0 overflow-hidden bg-slate-800 transition-opacity group-hover:opacity-90"
                                >
                                    <img
