<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-slate-600 dark:text-slate-400">{{ __('Two factor authentication') }}</h2>
    ...
    <section>
        ...
        @if ($enabled)
            @if ($showingQrCode)
                ...
                <div class="mt-4 inline-block bg-white p-2">{!! $user->twoFactorQrCodeSvg() !!}</div>
