    ...
    <div class="space-y-3">
        ...
        <div class="flex items-center gap-4">
            ...
            <button
                ...
                type="button"
                class="text-slate-600 hover:text-slate-400 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none dark:text-slate-400 dark:hover:text-slate-600"
            >
                Cancel
            </button>
        </div>
