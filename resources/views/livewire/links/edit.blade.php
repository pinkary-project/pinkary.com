<form wire:submit="update">
    <div class="space-y-3">
        ...
        <div>
            ...
            <p wire:dirty wire:target="url" class="mt-2 text-sm text-amber-100 text-slate-600">
        ...
        <div class="flex items-center gap-4">
            ...
            <button
                ...
                type="button"
                class="text-slate-600 hover:text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
            >
                Cancel
            </button>
        </div>
