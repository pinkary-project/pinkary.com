<div>
    <form wire:submit="update">
        <div class="mt-12">
            <label class="text-base font-semibold text-slate-600 dark:text-slate-400">Link Shape</label>
                    ...
                    @foreach (['rounded-none' => 'Square', 'rounded-lg' => 'Round', 'rounded-full' => 'Extra Round'] as $shape => $label)
                        <div class="flex items-center">
                            ...
                            <label
                                ...
                                class="ml-3 block text-sm leading-6 font-medium text-slate-500"
                            >
                                {{ $label }}
                            </label>
                        </div>
        ...
        <div class="mt-12">
            <label class="text-base font-semibold text-slate-600 dark:text-slate-400">Link Color</label>
                ...
                <div class="space-y-4">
                    @foreach ([
                        ...
                        <div class="flex justify-between">
                            ...
                            <label
                                for="{{ $gradient }}"
                                class="{{ $gradient }} relative block w-full cursor-pointer rounded-lg border bg-linear-to-r px-6 py-4 shadow-sm focus:outline-none sm:flex sm:justify-between"
                            >
                                <span
                                    class="pointer-events-none absolute -inset-px rounded-lg border-2 border-slate-50 shadow-md dark:border-slate-100 dark:shadow-none"
                                    aria-hidden="true"
                                ></span>
                            </label>
                        </div>
        ...
        <div class="mt-6 flex items-center gap-4">
            ...
            <button
                ...
                type="button"
                class="text-slate-400 hover:text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
            >
                Cancel
            </button>
        </div>
