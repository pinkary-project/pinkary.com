<x-app-layout>
    <div class="py-0"
        ...
        <section class="overflow-hidden border-x border-b border-slate-700/50 bg-[#07101f]/95">
        ...
        <section class="border-x border-b border-slate-700/50 bg-[#07101f]/95 px-6 py-6">
