<x-app-layout>
    <div class="flex flex-col items-center py-10">
        <div
            class="flex w-full max-w-md flex-col gap-12"
            x-data
        ...
        >
            <a
                x-data="{
                    fallback:
                        '{{ session('_previous.url', route('profile.show', ['username' => $question->to->username])) }}',
                ...
                class="flex cursor-pointer text-slate-500 hover:underline dark:text-slate-400"
            >
