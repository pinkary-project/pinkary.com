...
Route::prefix('v1')->as('api.v1.')->group(function (): void {
    ...
    Route::get('questions/{question}/comments', [QuestionController::class, 'comments'])
        ->middleware('auth:sanctum')
        ->name('questions.comments.index')
        ->whereUuid('question');

    Route::post('questions/{question}/comments', [QuestionController::class, 'storeComment'])
        ->middleware('auth:sanctum')
    ...
    Route::delete('questions/{question}/like', [QuestionController::class, 'unlike'])
        ->middleware('auth:sanctum')
    ...
    Route::delete('questions/{question}/bookmark', [QuestionController::class, 'unbookmark'])
        ->middleware('auth:sanctum')
        ->name('questions.unbookmark')
        ->whereUuid('question');

    Route::post('questions/{question}/poll/vote', [QuestionController::class, 'votePoll'])
        ->middleware('auth:sanctum')
    ...
    Route::delete('users/{user:username}/follow', [UserController::class, 'unfollow'])
        ->middleware('auth:sanctum')
        ->name('users.unfollow');
