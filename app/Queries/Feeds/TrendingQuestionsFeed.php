...
final readonly class TrendingQuestionsFeed
{
    ...
    public function builder(): Builder
    {
        ...
        // Time calculation using a universal approach
        $timeCalculation = "strftime('%s', 'now') - strftime('%s', questions.answer_created_at)";
        ...
        return Question::query()
            ...
            ->select(
                ...
                DB::raw('COUNT(DISTINCT child_questions.id) as children_count')
            )
