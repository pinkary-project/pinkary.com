...
test('fails when an existing remote file does not match the source', function () {
    Storage::disk('public')->put('avatars/existing.png', 'new-content');
    Storage::disk('s3')->put('avatars/existing.png', 'old');
